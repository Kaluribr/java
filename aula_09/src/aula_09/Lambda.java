...
public class Lambda {
	public static void main(String[] args) { 
		...
		System.out.println("\nExibir os itens somados com eles mesmos ulitizando a exprecao lambda\n");
		
		// Exibir os itens da Lista dobrados com Expressão Lambda
		numeros.forEach(n -> System.out.println(n + n)); /*peque cada posicao da minha colection e exiba na tela a soma com ele mesmo*/
		...
		System.out.println("\nExibir os itens pares da lista ulitizando a exprecao lambda\n");
