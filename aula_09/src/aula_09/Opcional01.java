...
public class Opcional01 {
		...
		public static void main(String[] args) {
			...
			palavras[2] = "Genetarion Brasil - Turma 61";
			...
			System.out.println(checaNulo2.isEmpty());// usando metodo isEmpty imprime true ou false
			System.out.println(checaNulo2.get()); // usando metodo get imprime o conteudo com o valor sem parenteses
	}
}
